...
### Slide deck navigation (`reports/classic-vs-hcp_autonode/`)
...
See **`reports/classic-vs-hcp_autonode/PROMPT.md`** (section *Slide anchors*) for the canonical wording. Decks cloned from **`references/mobb-deck-template/`** SHOULD follow the same pattern for reusability across projects.
